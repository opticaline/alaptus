...
import org.opticaline.framework.corebak.annotation.Param;
...
import org.opticaline.framework.corebak.format.Transaction;
...
public abstract class AnonymousLoader {
    ...
    public static class RouteLoader extends AnonymousLoader {
    ...
    public static class ParamTransactionLoader extends AnonymousLoader {
