...
public class RoutePathRewrite {
    ...
    public static String rewrite(String path) throws IllegalPathException {
        try {
            ...
            throw new org.opticaline.alaptus.core.exception.IllegalPathException("Error expression: [" + path + "].");
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(org.opticaline.alaptus.core.route.RoutePathRewrite.rewrite("Test<int:testint, length=[0-2]><string:teststring>"));
        System.out.println(org.opticaline.alaptus.core.route.RoutePathRewrite.rewrite("<int:testint, length=[0-2]>Url"));
    }
}
